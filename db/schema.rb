...
ActiveRecord::Schema[7.0].define(version: 20_231_213_144_803) do
  ...
  create_table 'bookmarks', force: :cascade do |t|
    ...
    t.index %w[user_id movie_id], name: 'index_bookmarks_on_user_id_and_movie_id', unique: true
  ...
  create_table 'reviews', force: :cascade do |t|
    ...
    t.bigint 'user_id', null: false
    t.text 'content'
    t.boolean 'contains_spoiler', default: false, null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
