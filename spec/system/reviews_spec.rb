...
RSpec.describe 'Reviews', type: :system do
  ...
  let!(:not_spoiler_review) { FactoryBot.create(:review, contains_spoiler: false, movie:, user:) }
  let!(:spoiler_review) { FactoryBot.create(:review, contains_spoiler: true, movie:, user:) }
